...
class Word2Vec():
    def __init__(self):
        ...
        self.model = gensim.models.Word2Vec.load_word2vec_format('./MSRP_Corpus/GoogleNews-vectors-negative300.bin',
                                                                     binary=True)
...
class MSRP(Data):
    def open_file(self, mode, parsing_method="normal"):
        with codecs.open("./MSRP_Corpus/msr_paraphrase_" + mode + ".txt", "r", "utf-8") as f:
            f.readline()
...
class WikiQA(Data):
    def open_file(self, mode):
        with codecs.open("./WikiQA_Corpus/WikiQA-" + mode + ".txt", "r", "utf-8") as f:
